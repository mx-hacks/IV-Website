(function() {
  ...
  angular
    ...
    var dudas = [{
      ...
      img2:'icon2',
      titulo2:'¿Major League Hacking apoya con reembolso de viajes?',
      respuesta2:'Desafortunadamente, Major League Hacking no es capaz de proveer reembolso en los viajes de los hackers. Hemos reembolsado viajes en el pasado en ciertos casos, pero siempre estamos en la búsqueda constante de encontrar formas más sustentables de llevar más estudiantes a los hackathons.'
    },{
      img:'icon3',
