(function() {
  ...
  angular
    ...
    var dudas = [{
      ...
      img2:'icon5',
      titulo2:'¿QuÉ́ pasa si no se programar?',
      ...
      img2:'icon10',
      titulo2:'Me acabo de graduar, ¿AÚN puedo asistir a un evento?',
      ...
      img:'icon4',
      titulo:'¿SeRá molesto para la gente si les hago preguntas?',
      ...
      respuesta2:'¡Por supuesto! Tus comidas para el fin de semana serán completamente gratuitas, además muchos bocadillos y bebidas durante el evento para mantenerte con energía. Si tienes requisitos dietéticos específicos, deberás de especificarlo en tu aplicación, así podremos tomar las medidas necesarias.',
    },{
      img:'icon7',
